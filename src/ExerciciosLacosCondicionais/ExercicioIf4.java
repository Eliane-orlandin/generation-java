...
public class ExercicioIf4 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Digite a primeira característica: (vertebrado ou invertebrado)");
		caracteristica1 = leia.next();
		
		System.out.println("Digite a segunda característica: (ave, mamifero, inseto ou anelideo)");
		caracteristica2 = leia.next();
		
		System.out.println("Digite a terceira característica: (carnivoro, onivoro, herbivoro ou hematofago)");
		...
		if (caracteristica1.equalsIgnoreCase("vertebrado")) {
			...
			if(caracteristica2.equalsIgnoreCase("inseto")) {
				...
				} else if (caracteristica3.contentEquals("herbivoro")) {
